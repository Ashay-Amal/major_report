...
The generator network processes input images using a well-structured encoder–transformer–decoder architecture designed to gradually extract features and produce the final stylized output, as shown in Figure \ref{fig:generator_lld}.
