...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Training Loss Curves - One Piece Style Model}
\label{fig:loss_onepiece}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Training Loss Curves - Disney Style Model}
\label{fig:loss_disney}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Training Loss Curves - Studio Ghibli Style Model}
\label{fig:loss_ghibli}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Training Loss Curves - Van Gogh Style Model}
\label{fig:loss_vangogh}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{One Piece Style Transfer Results - Sample 1}
\label{fig:results_onepiece_1}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{One Piece Style Transfer Results - Sample 2}
...
\subsection{Style Comparison Grid}

\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Comparison of All Style Transfers on Same Input - Set 1}
\label{fig:style_comparison_1}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Comparison of All Style Transfers on Same Input - Set 2}
\label{fig:style_comparison_2}
\end{figure}
...
Time taken to process a single 256$\times$256 image.

\textbf{3. Cycle Consistency Error:}\\
...
\hline
\textbf{Metric} & \textbf{One Piece} & \textbf{Disney} & \textbf{Ghibli} & \textbf{Van Gogh} \\ \hline
FID Score ($\downarrow$) & -- & -- & -- & -- \\ \hline
Inference Time (ms) & -- & -- & -- & -- \\ \hline
Cycle Consistency Error & -- & -- & -- & -- \\ \hline
Model Size (MB) & -- & -- & -- & -- \\ \hline
GPU Memory Usage (GB) & -- & -- & -- & -- \\ \hline
\end{tabular}
\end{table}

\textit{Note: Fill in actual metric values from your evaluation.}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Examples of Failure Cases - Set 1}
\label{fig:failure_cases_1}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\includegraphics[width=0.45\textwidth]{images/ghibli_generated.png}
\caption{Examples of Failure Cases - Set 2}
\label{fig:failure_cases_2}
\end{figure}

\textbf{Identified Limitations:}
\begin{enumerate}
    \item \textbf{Extreme Poses:} Side profiles and extreme angles may produce inconsistent results
    \item \textbf{Occlusion:} Partially covered faces may have artifacts
    \item \textbf{Complex Backgrounds:} Background elements may interfere with face stylization
    \item \textbf{Very Dark/Bright Images:} Extreme lighting conditions affect quality
    \item \textbf{Non-Standard Faces:} Very unusual facial features may not transform well
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Style Fidelity:} All models capture distinctive style characteristics (One Piece outlines, Disney gradients, Ghibli textures, Van Gogh brushstrokes).
...
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Method} & \textbf{Style Quality} & \textbf{Speed} & \textbf{Unpaired Data} & \textbf{Animation} \\ \hline
Gatys et al. (2016) & High & Slow (minutes) & N/A & Limited \\ \hline
Johnson et al. (2016) & Medium-High & Fast & No & Limited \\ \hline
AdaIN (2017) & High & Fast & N/A & Limited \\ \hline
CartoonGAN (2018) & High & Fast & No & Yes \\ \hline
AnimeGAN (2019) & Medium-High & Fast & No & Yes \\ \hline
\textbf{Our Method} & High & Fast ($<$1s) & Yes & Yes \\ \hline
\end{tabular}
\end{table}
