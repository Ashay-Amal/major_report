...
\textbf{A Neural Algorithm of Artistic Style:}
...
\vspace{0.5cm}
\textbf{Instance Normalization: The Missing Ingredient for Fast Stylization:}
...
\vspace{0.5cm}
\textbf{Arbitrary Style Transfer in Real-Time With Adaptive Instance Normalization:}
...
\vspace{0.5cm}
\textbf{Universal Style Transfer via Feature Transforms:}
...
\vspace{0.5cm}
\textbf{Exploring the Structure of a Real-Time, Arbitrary Stylization Network:}
...
\vspace{0.5cm}
\textbf{Deep Photo Style Transfer:}
...
\vspace{0.5cm}
\textbf{Unpaired Image-to-Image Translation Using Cycle-Consistent Adversarial Networks:}
...
\vspace{0.5cm}
\textbf{Applying Deep Learning for Style Transfer in Digital Art:}
...
\vspace{0.5cm}
\textbf{Blending Art and Intelligence: Advances in Neural Style Transfer and Image Synthesis:}
