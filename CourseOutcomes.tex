...
\newpage
\begin{table}[ht]
\caption*{\textbf{CO-PO and PSO Mapping}}
\resizebox{\textwidth}{!}{%
...
\\POs(Program Outcomes):\vspace{-0.5em}\\PO1: Engineering knowledge,\\ PO2: Problem analysis,\\ PO3: Design of solutions, \\PO4: Conduct investigations of complex problems,
...
\\PSOs(Program Specific Outcomes):\vspace{-0.5em}\\PSO1: Computer-based systems development,\\ PSO2: Software development,\\ PSO3: Computer communications and Internet applications.
